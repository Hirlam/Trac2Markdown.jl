...
The final namelists are build through the rules given in [Get_namelist](https://hirlam.org/trac/browser/Harmonie/scr/Get_namelist?rev# release-43h2.beta.3) and are generated by [gen_namelists.pl](https://hirlam.org/trac/browser/Harmonie/nam/gen_namelists.pl?revrelease-43h2.beta.3). Note that in several cases environment variables are still parsed in the scripts.
