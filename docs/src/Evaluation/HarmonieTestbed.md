...
[config_exp.h](Harmonie/ecf/config_exp.h?rev=release-43h2.beta.3), [include.ass](Harmonie/scr/include.ass?rev=release-43h2.beta.3) and [harmonie.pm](Harmonie/suites/harmonie.pm?rev=release-43h2.beta.3). These configurations are controlled by the script 
