```@meta
EditURL="https://hirlam.org/trac//wiki//Evaluation/HarmonieTestbed?action=edit"
```
...
[mitraillette](./Evaluation/Mitraillette.md) runs test on the hart of the model, the dynamical core. The HARMONIE testbed tests the full script system as it is supposed to be used.
