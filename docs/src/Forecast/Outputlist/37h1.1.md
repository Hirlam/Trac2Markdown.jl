...
|SURFRAYT DIR SUR  |J m-2   | 117 | 105 |   0 | [[Color(blue, Level set to 0, time-range ind. set to 4.)]] Surf direct solar flux (Accumulated Surface parallel solar flux) |
|[[Color(green, SURFCHAL LATENTE)]]  | J m-2 | 121 |105|  0 | [[Color(blue, time-range ind. set to 4.)]] Accunmulated surface latent heat flux |
...
|SURFFLU.LAT.MEVA  |J m-2   | 131 | 105 |   0 | [[Color(blue, Prameter identifier was 121, Time-range ind. set to 4.)]] Accumulated latent heat evaporation |
...
|SOMMRAYT.TERREST  |W m-2   | 114 |   8 |   0 | [[Color(blue, Levle was 667, time-range ind. set to 0.)]] TOA Instantaneous LW radiation |
|TOPRAYT_DIR_SOM   |W m-2   | 117 |   8 |   0 | [[Color(blue, Levle was 666, time-range ind. set to 4.)]] TOA direct solar radiation |
