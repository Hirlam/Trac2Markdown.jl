```@meta
EditURL="https://hirlam.org/trac//wiki//Installation/gmkpack?action=edit"
```
...
Compare e.g. with [config.ecgb](https://hirlam.org/trac/browser/Harmonie/config-sh/config.ecgb) or [config.gimle](https://hirlam.org/trac/browser/Harmonie/config-sh/config.gimle).
...
On [ecgb](https://hirlam.org/trac/browser/Harmonie/config-sh/submit.ecgb) three list of jobs are created:
